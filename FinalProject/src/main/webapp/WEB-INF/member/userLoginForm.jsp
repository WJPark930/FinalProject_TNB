...
<div class="container" id="content_container">
    <div class="login-container">
        <div class="login-box">
            ...
            <div class="sns-login">
                <div>
                    <a href="javascript:kakaoLogin()" class="input-group">
                    
    <img src="https://k.kakaocdn.net/14/dn/btroDszwNrM/I6efHub1SN5KCJqLm1Ovx1/o.jpg" width="360" height="44" alt="카카오 로그인 버튼">
                    </a>
                </div>
                <div id="naverIdLogin" class="input-group">  
                    <script type="text/javascript">
                ...
                %>
                <div class="input-group">
    <a href="<%=insertuserMember%>" class="btn btn-user">일반 사용자 회원가입</a>
                </div>
                <div class="input-group">
    <a href="<%=insertBusinessMember%>" class="btn btn-business">사업자 회원가입</a>
           </div>
                <div class="links">
