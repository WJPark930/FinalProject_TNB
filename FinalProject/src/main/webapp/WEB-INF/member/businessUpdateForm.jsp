...
<tr>
        ...
        <tr>
            <th>* 이메일</th>
            <td>
                <input type="text" name="user_email" value="${member.user_email}" placeholder="이메일을 입력해주세요">
        ...
        <tr>
            <th>* 닉네임</th>
            <td>
                <input type="text" name="user_nickname" value="${member.user_nickname}" placeholder="닉네임을 입력해주세요">
    ...
    <td>
        ...
        <tr>
            <th colspan="2" align="center">
                <input type="submit" value="정보수정" onClick = "return checkData()">
