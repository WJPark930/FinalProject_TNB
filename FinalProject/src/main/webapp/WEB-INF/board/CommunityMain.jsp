...
<div class="container" id="container">
	...
	<div class="btn-group" role="group" aria-label="Basic mixed styles example">
	    <button type="button" class="btn btn-success" onclick="filterByCategory(1)" style="background-color: #80B156; border: 0px;">전체 게시판</button>
	    <button type="button" class="btn btn-success" onclick="filterByCategory(2)" style="background-color: #80B156; border: 0px;">자유 게시판</button>
	    <button type="button" class="btn btn-success" onclick="filterByCategory(3)" style="background-color: #80B156; border: 0px;">구인 · 구직 게시판</button>
	    <button type="button" class="btn btn-success" onclick="startChat()" style="background-color: #80B156; border: 0px;">채팅 시작하기</button>
	</div>
	
	<div id="boardName" align="center">전체 게시판</div>
	</div>
	...
	<div class="container_cummunity row">
	    ...
	    <div class="right_section col-9">
	        <form id="searchForm" action="list.bd" align="center">
	            ...
	            <input type="button" class="btn btn-success" name="insert" value="추가하기" onclick="location.href='write.bd'">
	        </form>
